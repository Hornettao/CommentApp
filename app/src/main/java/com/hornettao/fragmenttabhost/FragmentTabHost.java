package com.hornettao.fragmenttabhost;
...
/**
 * Special TabHost that allows the use of {@link android.app.Fragment} objects for its tab
 * content. When placing this in a view hierarchy, after inflating the hierarchy
 * you must call {@link #setup(android.content.Context, android.app.FragmentManager, int)} to complete the
...
public class FragmentTabHost extends TabHost implements
     ...
     *             {@link #setup(android.content.Context, android.app.FragmentManager)} or
     *             {@link #setup(android.content.Context, android.app.FragmentManager, int)}.
     */
    @Override
    @Deprecated
    public void setup() {
